...
void Server::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->clientDisconnected((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        case 1: _t->saved((*reinterpret_cast< std::add_pointer_t<QPixmap>>(_a[1]))); break;
        case 2: _t->fileListUpdated(); break;
        case 3: _t->clientListUpdated(); break;
        case 4: _t->handleClient((*reinterpret_cast< std::add_pointer_t<qintptr>>(_a[1]))); break;
        case 5: _t->aware(); break;
        default: ;
        }
        ...
        {
            using _t = void (Server::*)(QPixmap );
            if (_t _q_method = &Server::saved; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &Server::fileListUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (Server::*)();
            if (_t _q_method = &Server::clientListUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 0
void Server::clientDisconnected(int _t1)
{
...
// SIGNAL 2
void Server::fileListUpdated()
{
    QMetaObject::activate(this, &staticMetaObject, 2, nullptr);
}

// SIGNAL 3
void Server::clientListUpdated()
{
